...
boxplot(data_3, plot = TRUE)
hist(data_3$GDP, plot = TRUE)

boxplot(data_3$GFCF, plot = TRUE)
hist(data_3$GFCF, plot = TRUE)

boxplot(data_3$UNEM, plot = TRUE)
hist(data_3$UNEM, plot = TRUE)

boxplot(data_3$ConsumerPrices, plot = TRUE)
hist(data_3$ConsumerPrices, plot = TRUE)

boxplot(data_3$GovExp , plot = TRUE)
hist(data_3$GovExp, plot = TRUE)

boxplot(data_3$HouseExp, plot = TRUE)
hist(data_3$HouseExp, plot = TRUE)
